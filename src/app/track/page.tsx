...
const statusConfig: Record<ApplicationStatus, { icon: string; color: string; bg: string; border: string; message: string }> = {
  new: {
    ...
    message: 'طلبك قيد المراجعة. نراجع حاليًا بياناتك وأعمالك السابقة بعناية للتأكد من توافقها مع معايير شبكة إترا التقنية. سيتم تحديث حالة الطلب عند اكتمال المراجعة.',
  },
  under_review: {
    icon: '🔍',
    color: '#60A5FA',
  ...
  accepted: {
    ...
    message: 'تم قبول طلبك للانضمام إلى شبكة مبدعين إترا. سيتواصل معك فريقنا قريبًا لاستكمال خطوات التعاون.',
  },
  rejected: {
    icon: '❌',
    color: '#F87171',
    ...
    message: 'لم يتم اعتماد طلبك في هذه المرحلة. يمكنك إعادة التقديم لاحقًا عند توفر فرص متوافقة مع تخصصك.',
  },
}
    ...
    <div className="min-h-screen" style={{ background: '#0D0D1A' }}>
      ...
      <main className="max-w-2xl mx-auto px-4 py-16">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-center mb-10 max-w-xl mx-auto leading-relaxed" style={{ color: '#B0A8D4' }}>
            أدخل رمز التتبع الخاص بك للاطلاع على آخر تحديث لطلب انضمامك إلى شبكة مبدعين إترا.
          </p>
